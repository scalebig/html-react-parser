(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else root['HTMLReactParser'] = factory(root['React']);
  ...
  return /******/ (function(modules) {
    ...
    /******/ [
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var htmlToDOM = __webpack_require__(14); // decode HTML entities by default for `htmlparser2`

        var domParserOptionsDefault = {
          decodeEntities: true,
        ...
        function HTMLReactParser(html, options) {
          ...
          return domToReact(
            htmlToDOM(
              html,
              _objectSpread({}, domParserOptionsDefault, {
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var DOMProperty = __webpack_require__(0);

        var propertyConfig = __webpack_require__(9);
        ...
        var isCustomAttribute =
          propertyConfig.HTMLDOMPropertyConfig.isCustomAttribute;
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var HTMLDOMPropertyConfig = __webpack_require__(10);
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        module.exports = function parseInlineStyle(style, iterator) {
          ...
          var declarations = parse('p{' + style + '}').stylesheet.rules[0]
            .declarations;
          ...
          switch (tagName) {
            ...
            case HEAD_TAG_NAME:
              if (parseWithFallback) {
                elements = parseWithFallback(html).getElementsByTagName(
                  HEAD_TAG_NAME
                );
